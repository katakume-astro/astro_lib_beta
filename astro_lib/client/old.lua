...
AddEventHandler('Astro-NotifySystem:Notify', function(type, msg, duration)
	...
	print(("[^1ERROR^7] Resource ^5%s^7 Used the ^5Astro-NotifySystem:Notify^7 Event, this event ^1no longer supported!^7 Visit https://github.com/katakume-astro/astro_lib_beta/edit/main/astro_lib/client/old.lua for how to fix it!"):format(Invoke))
end)
